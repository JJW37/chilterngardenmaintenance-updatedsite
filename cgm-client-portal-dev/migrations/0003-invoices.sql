-- CGM Client Portal: invoices, payments and bank-transfer details.
-- Apply this migration once to the existing D1 database before publishing
-- invoice pages that use it.
