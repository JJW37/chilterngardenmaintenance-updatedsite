...
(function () {
  ...
  async function openInvoice(id) {
    try {
      ...
      var pdfButton = invoice.hasPdf ? '<a class="btn-portal btn-ghost" href="/api/client-invoice-pdf?id=' + invoice.id + '&clientId=' + invoice.clientId + '">Download PDF</a>' : '<button class="btn-portal btn-ghost" type="button" id="attachPdfBtn">Attach PDF</button>';
